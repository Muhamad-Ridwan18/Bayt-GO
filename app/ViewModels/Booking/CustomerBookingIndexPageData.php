...
final class CustomerBookingIndexPageData
{
    /**
     * @param  array<string, int>  $bookingStatusCounts
     * @param  array<string, BookingIndexCardData>  $bookingCards
     */
    ...
    public static function make(
        ...
        foreach ($bookings as $booking) {
            $cards[(string) $booking->getKey()] = BookingIndexCardData::forCustomer($booking, $addonsById);
        }
