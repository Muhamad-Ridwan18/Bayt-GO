...
final class LayananShowPageData
{
    ...
    public static function make(
        ...
        return new self(
            ...
            seoTitle: __('seo.profile_title', ['name' => $muthowifName]),
            seoDesc: __('seo.profile_description', ['name' => $muthowifName]),
    ...
    private static function schema(
        ...
        $schema = [
            ...
            'description' => __('seo.profile_schema_description', ['name' => $muthowifName]),
            'url' => route('layanan.show', $profile),
            'priceRange' => $minPrice ? 'IDR '.number_format($minPrice, 0, ',', '.') : __('seo.profile_price_on_request'),
            'address' => [
                '@type' => 'PostalAddress',
                'addressCountry' => 'ID',
            ],
