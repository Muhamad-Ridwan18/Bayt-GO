...
return [
    ...
    'phone_national_hint' => 'Local number without country code (for Indonesia you may use 08… or 8…).',
    'register_phone_hint' => 'WhatsApp number. OTP verification happens on the next step after you submit this form.',
