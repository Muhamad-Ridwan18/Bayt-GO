...
return [
    ...
    'replacements' => [
        ...
        'badge_opportunity' => 'New request',
        'original_guide' => 'Replacing: :name',
        'incident_heading' => 'Incident & notes',
        'incident_status' => 'Incident status',
        'admin_note' => 'BaytGo note',
        'pending_actions' => 'Actions',
        'back_bookings' => 'Booking requests',
        'tabs_aria' => 'Replacement assignment filters',
        'tab_pending' => 'Awaiting confirmation',
        'tab_active' => 'In progress',
        'tab_history' => 'History',
        'empty_active' => 'No active assignments yet. After you confirm or volunteer, entries appear here.',
        'empty_history' => 'No declined or closed assignments yet.',
        'status_heading' => 'Assignment status',
        'hint_waiting_customer' => 'Waiting for the pilgrim to choose from approved candidates.',
