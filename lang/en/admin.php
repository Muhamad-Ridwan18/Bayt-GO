...
return [
    ...
    'finance' => [
        ...
        'platform_from_orders_line' => 'From payments: full fee if active; half of recorded platform fee (7.5% of base) if refunded — Rp :amount',
        'platform_from_refunds_line' => 'From completed refunds (admin deduction :pct% of base): Rp :amount',
        'platform_card_note' => 'Total = both lines. For refunded bookings: payments contribute half the stored platform fee (retained share) plus refund admin fee — not full 15%+15%.',
