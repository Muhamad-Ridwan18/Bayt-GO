...
return [
    ...
    'finance' => [
        ...
        'platform_from_orders_line' => 'From settled payments (bookings not refunded; :pct% of base): Rp :amount',
        'platform_from_refunds_line' => 'From completed refunds (admin deduction :pct% of base): Rp :amount',
        'platform_card_note' => 'The headline sums both. Refunded bookings are excluded from the payment row so order fees are not added twice — only the refund admin fee counts for those.',
