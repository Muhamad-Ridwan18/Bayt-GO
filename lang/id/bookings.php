...
return [
    ...
    'payment' => [
        ...
        'step_4' => 'Status booking akan update otomatis setelah pembayaran dikonfirmasi oleh DOKU.',
        'waiting_auto' => 'Menunggu konfirmasi pembayaran otomatis...',
        'view_detail' => 'Lihat detail booking',
        'order_summary' => 'Ringkasan pesanan',
        'order_id' => 'Order ID',
        'help_title' => 'Bantuan',
        'help_body' => 'Setelah pembayaran berhasil, halaman ini akan mengarah ke detail booking saat DOKU mengirim notifikasi ke sistem kami.',
