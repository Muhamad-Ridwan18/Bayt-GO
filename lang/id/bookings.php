...
return [
    ...
    'show' => [
        ...
        'refund_breakdown_html' => 'Dari harga dasar Rp :base: potongan admin Rp :platform (order batal, tanpa potongan muthowif). Total yang Anda bayar Rp :paid (sudah termasuk biaya platform di pembayaran).',
