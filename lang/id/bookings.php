...
return [
    ...
    'show' => [
        ...
        'muthowif_slot_full_apology' => 'Mohon maaf — :name tidak dapat menerima booking ini karena jadwal pendampingan pada tanggal tersebut sudah penuh.',
        'muthowif_rejection_note_label' => 'Catatan muthowif:',
        'referral_network_heading' => 'Rekomendasi muthowif dari jaringan yang sama',
        'referral_network_intro' => 'Berikut muthowif lain yang mendaftar dengan kode referral dari muthowif di atas, menawarkan jenis layanan yang sama, dan memiliki slot kosong untuk tanggal serta jumlah jemaah Anda.',
        ...
        'referral_network_view_profile' => 'Lihat profil & booking',
    ...
    'payment' => [
        ...
        'step_4' => 'Status booking akan diperbarui otomatis setelah pembayaran terverifikasi oleh sistem.',
        'waiting_auto' => 'Menunggu konfirmasi pembayaran otomatis...',
        'view_detail' => 'Lihat detail booking',
        'order_summary' => 'Ringkasan pesanan',
        'order_id' => 'Order ID',
        'help_title' => 'Bantuan',
        'help_body' => 'Setelah pembayaran berhasil, halaman ini akan mengarah ke detail booking setelah penyedia pembayaran mengonfirmasi ke sistem kami.',
