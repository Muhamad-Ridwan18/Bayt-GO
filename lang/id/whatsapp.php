...
return [
    ...
    'customer' => [
        ...
        'payment_settled' => [
            'headline' => '*:app* — pembayaran lunas',
            'body' => 'Pembayaran pesanan Anda dengan *:muthowif* sudah kami terima.',
            'booking_code' => '*Kode pesanan:* :code',
            'service_dates' => '*Tanggal layanan:* :start - :end',
            'amount' => '*Total dibayar:* Rp :amount',
            'status' => '*Status:* Lunas — layanan siap berjalan sesuai jadwal.',
            'view_detail' => '*Detail pesanan:*',
            'invoice_link' => '*Invoice (buka link):* :url',
        ],
        'support_payment_settled' => [
            'headline' => '*:app* — layanan pendukung lunas',
            'body' => 'Pembayaran layanan pendukung dengan *:muthowif* sudah kami terima.',
            'booking_code' => '*Kode pesanan:* :code',
            'package' => '*Paket:* :package',
            'starts_at' => '*Jadwal mulai:* :datetime',
            'amount' => '*Total dibayar:* Rp :amount',
        ...
        'support_completion_rejected' => [
            ...
            'booking_code' => '*Kode pesanan:* :code',
            'package' => '*Paket:* :package',
            'hint' => 'Layanan tetap berjalan. Anda bisa menandai selesai lagi setelah kegiatan beres.',
            'view_detail' => '*Lihat detail pesanan:*',
        ],
        'support_rejected_jadwal_full' => [
            'headline' => '*:app* — layanan pendukung tidak dapat dilanjutkan',
            'body' => 'Mohon maaf, muthowif *:muthowif* menolak karena jadwal di tanggal tersebut sudah penuh.',
            'booking_code' => '*Kode pesanan:* :code',
            'package' => '*Paket:* :package',
            'starts_at' => '*Jadwal yang diajukan:* :datetime',
            'hint' => 'Silakan pilih tanggal/jam lain di katalog layanan pendukung.',
            'view_detail' => '*Detail pesanan:*',
        ],
        'support_rejected' => [
            'headline' => '*:app* — layanan pendukung dibatalkan',
            'body' => 'Mohon maaf, muthowif *:muthowif* menolak permintaan layanan pendukung Anda.',
            'body_confirmed_cancelled' => 'Muthowif *:muthowif* membatalkan pesanan layanan pendukung yang sudah dikonfirmasi.',
            'reason' => '*Alasan:* :reason',
            'booking_code' => '*Kode pesanan:* :code',
            'package' => '*Paket:* :package',
            'starts_at' => '*Jadwal mulai:* :datetime',
            'hint' => 'Anda bisa memesan paket lain atau jadwal berbeda di katalog.',
