    ...
    public function test_official_api_sends_e164_target_with_country_code_bypass(): void
    {
        ...
        Http::assertSent(function ($request): bool {
            return $request->url() === 'https://api.fonnte.com/send'
                ...
                && $request->data()['countryCode'] === '90';
        });
    }

    public function test_official_api_sends_turkey_505_with_country_code_90(): void
    {
        Http::fake([
            'https://api.fonnte.com/send' => Http::response([
                'status' => true,
        ...
        $dial = IntlPhone::fonnteDial('+905050556273');
        $this->assertNotNull($dial);
        ...
        Http::assertSent(function ($request): bool {
            return $request->data()['target'] === '905050556273'
                && $request->data()['countryCode'] === '90';
        });
    }

    public function test_official_api_keeps_indonesian_e164_with_matching_country_code(): void
    {
        Http::fake([
            'https://api.fonnte.com/send' => Http::response([
                'status' => true,
