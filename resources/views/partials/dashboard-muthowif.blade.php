...
>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
            x-data="{ copied: false }"
            class="overflow-hidden rounded-2xl border border-emerald-200/80 bg-emerald-50/60 shadow-sm ring-1 ring-emerald-100/80"
        >
            ...
            <div class="border-t border-emerald-200/60 bg-white/40 px-5 py-4">
