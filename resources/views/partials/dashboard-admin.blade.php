            ...
            <aside class="space-y-5 lg:col-span-4">
                <div class="rounded-3xl border border-slate-200/90 bg-white p-5 shadow-md shadow-slate-900/5 ring-1 ring-slate-100/90">
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-2.5">
                        ...
                        <a href="{{ route('admin.logs.index') }}" class="group col-span-2 flex flex-col items-center gap-2 rounded-2xl border border-dashed border-slate-300/90 bg-slate-50 px-3 py-4 text-center transition hover:border-slate-400 hover:bg-white">
