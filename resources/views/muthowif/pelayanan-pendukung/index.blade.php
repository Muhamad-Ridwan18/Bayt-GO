@php
    ...
    $createUrl = route('muthowif.pelayanan-pendukung.create', ['category' => $categoryFilter->value]);
                        ...
                        <li class="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-sm ring-1 ring-slate-100/80 transition duration-300 hover:-translate-y-0.5 hover:border-baytgo/25 hover:shadow-lg hover:shadow-baytgo/5">
                            ...
                            <div class="flex flex-1 flex-col p-5">
                                ...
                                <div class="mt-auto flex gap-2 border-t border-slate-100 pt-4">
                                    <a href="{{ route('muthowif.pelayanan-pendukung.edit', ['supportPackage' => $package, 'category' => $categoryFilter?->value ?? $package->category?->value]) }}" class="inline-flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-baytgo px-3 py-2.5 text-sm font-semibold text-white shadow-sm shadow-baytgo/15 transition hover:bg-baytgo-800">
