...
>
    <div class="pointer-events-auto mx-auto flex max-w-[21rem] items-stretch gap-0.5 rounded-2xl border border-slate-200/90 bg-white/95 px-1.5 py-1.5 shadow-[0_10px_32px_-10px_rgba(15,42,37,0.28)] backdrop-blur">
        ...
        >
            ...
            <span class="truncate">{{ __('dashboard.customer_bottom_home') }}</span>
        </a>
        ...
        >
            ...
            <span class="truncate">{{ __('dashboard.customer_bottom_bookings') }}</span>
        </a>
        ...
        >
            ...
            <span class="truncate">{{ __('dashboard.customer_bottom_chat') }}</span>
        </a>
        ...
        >
            ...
            <span class="truncate">{{ __('dashboard.customer_bottom_account') }}</span>
        </a>
    </div>
</nav>
@endif
