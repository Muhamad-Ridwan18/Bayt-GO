...
@php
    ...
    /** Urutan: kawasan umum; `iso` = ISO 3166-1 alpha-2 (disimpan ke users.country). */
    $countries = [
        ['d' => '62', 'iso' => 'ID', 'flag' => '🇮🇩', 'name' => 'Indonesia'],
        ...
        ['d' => '41', 'iso' => 'CH', 'flag' => '🇨🇭', 'name' => 'Switzerland'],
    ...
    if ($nationalInit !== '' || ($value !== null && $value !== '')) {
        ...
        if (! $inList && $dialInit !== '') {
            array_unshift($countries, ['d' => $dialInit, 'flag' => '🌐', 'name' => 'Other']);
        }
    }
...
<div
    ...
    x-data='{
        ...
        selected() {
            ...
            if (x) return x;
            return { d: this.phoneDial, flag: "🌐", name: "Other" };
        },
        fullPhone() {
