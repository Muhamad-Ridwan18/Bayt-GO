...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-gold text-sm font-medium leading-5 text-slate-900 focus:outline-none focus:border-gold-muted transition duration-150 ease-in-out'
