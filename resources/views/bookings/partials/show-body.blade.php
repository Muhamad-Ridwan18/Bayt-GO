        ...
        <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
            <div class="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
                ...
                <div class="flex flex-col gap-3 w-full sm:w-auto shrink-0 mt-4 sm:mt-0">
                    <a href="{{ route('bookings.chat.messages', $b) }}" class="inline-flex w-full sm:w-[130px] items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50">
