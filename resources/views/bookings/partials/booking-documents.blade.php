        ...
        <section class="overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-sm ring-1 ring-slate-100/80">
            ...
            <div class="grid grid-cols-1 gap-3 p-5 sm:grid-cols-2 sm:p-6 xl:grid-cols-3">
                @foreach ($items as $item)
                    ...
                    <div class="flex flex-col rounded-xl border border-slate-100 bg-slate-50/60 p-4">
                        <div class="flex items-start gap-3">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg {{ $kind === 'pdf' ? 'bg-red-50 text-red-600' : 'bg-slate-100 text-slate-600' }}">
                                @if ($kind === 'pdf')
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="mt-0.5 text-xs text-slate-500">{{ $docFormatLabel($item['path']) }}</p>
                            </div>
                        </div>
                        <a
                            ...
                            class="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-brand-700 hover:text-brand-800"
                        >
