                    ...
                    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-12 sm:pb-16">
                        <div class="max-w-3xl flex flex-col gap-5">
                            ...
                            <h1 class="text-3xl sm:text-5xl font-bold leading-[1.12] sm:leading-[1.1] tracking-tight text-white">
                                <span class="block">{{ __('welcome.hero_title_l1_before') }} {{ __('welcome.hero_title_l1_mark') }}</span>
                                <span class="block mt-1 sm:mt-1.5">{{ __('welcome.hero_title_l2_before') }} {{ __('welcome.hero_title_l2_mark') }}</span>
                                <span class="block mt-1 sm:mt-1.5">{{ __('welcome.hero_title_l3_mark') }}</span>
                            </h1>
