...
>
    <article>
        <header class="relative overflow-hidden border-b border-slate-100 bg-gradient-to-b from-welcomeCanvas via-welcomeCanvas/80 to-white">
            ...
            <x-page-container class="relative py-8 sm:py-12">
                <div class="mx-auto w-full max-w-5xl">
                    ...
                    <div class="mt-8 max-w-3xl {{ $rtl ? 'text-right' : '' }}">
                        @if ($category !== '')
                    ...
                    @if ($coverImage)
                        <figure class="mt-8 overflow-hidden rounded-2xl border border-slate-200/70 bg-slate-100 shadow-lg shadow-slate-900/5 sm:mt-10 sm:rounded-3xl">
                            <img
                                src="{{ $coverImage }}"
                                alt="{{ $title }}"
        ...
        <x-page-container class="py-10 sm:py-14">
            <div class="mx-auto w-full max-w-5xl">
                <div class="grid gap-10 lg:grid-cols-[minmax(0,1fr)_16rem] lg:items-start xl:grid-cols-[minmax(0,1fr)_18rem] xl:gap-12">
                    <div class="article-prose min-w-0 {{ $rtl ? 'text-right' : '' }}" dir="{{ $rtl ? 'rtl' : 'ltr' }}">
                        {!! $article->bodyHtmlForReading() !!}
                    </div>
