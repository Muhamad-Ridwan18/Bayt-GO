@php
    ...
    $broadcastConfig = [
        'initialFreeNumbers' => old('free_numbers', ''),
        'initialSearch' => $search,
        'labels' => [
            'selectedCount' => __('admin.whatsapp_broadcast.selected_count'),
            'freeCount' => __('admin.whatsapp_broadcast.free_count'),
            'totalEstimate' => __('admin.whatsapp_broadcast.total_estimate'),
            'recipientsRequired' => __('admin.whatsapp_broadcast.recipients_required'),
            'messageOrAttachmentRequired' => __('admin.whatsapp_broadcast.message_or_attachment_required'),
            'confirmSend' => __('admin.whatsapp_broadcast.confirm_send'),
        ],
    ];
@endphp
