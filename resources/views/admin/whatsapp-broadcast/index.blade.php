...
<x-app-layout>
    <x-ui.app-page
        x-data="whatsappBroadcastAdmin({
            ...
            labels: {
                selectedCount: @js(__('admin.whatsapp_broadcast.selected_count')),
                freeCount: @js(__('admin.whatsapp_broadcast.free_count')),
                totalEstimate: @js(__('admin.whatsapp_broadcast.total_estimate')),
                recipientsRequired: @js(__('admin.whatsapp_broadcast.recipients_required')),
                messageOrAttachmentRequired: @js(__('admin.whatsapp_broadcast.message_or_attachment_required')),
                confirmSend: @js(__('admin.whatsapp_broadcast.confirm_send')),
            },
        })"
    >
