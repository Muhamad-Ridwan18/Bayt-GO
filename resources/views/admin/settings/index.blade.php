        ...
        <x-page-container class="ui-stack-compact">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <ul class="divide-y divide-slate-100" role="list">
                    ...
                    <li>
                        <a href="{{ route('admin.whatsapp-notify-settings.edit') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-emerald-800" aria-hidden="true">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" /></svg>
                            </span>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_whatsapp_notify') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_whatsapp_notify_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.booking-payment-deadline-settings.edit') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_payment_deadline') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_payment_deadline_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.mailjet-test.edit') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-sky-100 text-sky-800" aria-hidden="true">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" /></svg>
                            </span>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_mailjet') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_mailjet_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.referrals.index') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-violet-100 text-violet-800" aria-hidden="true">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.09 9.09 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>
                            </span>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_referrals') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_referrals_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.seo-meta-settings.edit') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-emerald-800" aria-hidden="true">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_seo_meta') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_seo_meta_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.moota-api-settings.edit') }}" class="flex items-center gap-4 py-4 transition hover:bg-slate-50/80">
                            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-100 text-teal-800" aria-hidden="true">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z" /></svg>
                            </span>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-slate-900">{{ __('admin.settings_hub.card_moota_api') }}</p>
                                <p class="text-xs text-slate-500">{{ __('admin.settings_hub.card_moota_api_sub') }}</p>
                            </div>
                            <svg class="h-5 w-5 shrink-0 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </a>
                    </li>
